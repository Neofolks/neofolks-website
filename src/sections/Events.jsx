...
function Events() {
  return (
    <>
    <div className="flex flex-col w-full md:px-10 px-3" id='events'>
        ...
        <div className='min-h-[500px] flex flex-col md:flex-row justify-center md:justify-between items-center gap-4 md:gap-0'>
            {/* Left side img */}
            <div className='bg-[#838383] bg-opacity-10 aspect-video rounded-xl p-8 md:p-0 w-2/3 max-w-[500px] flex justify-center items-center'  id='redbg'>
    ...
    {/* CAD Chaos */}
    <div className='min-h-[500px] flex flex-col md:flex-row justify-center md:justify-between items-center gap-4 md:gap-0 w-full md:px-10 px-3'>
        {/* Left side text and button */}
        <div className='w-full md:w-1/3 flex flex-col gap-4 md:items-start items-center'>
            <div className="font-['familjen_grotesk']">
                <h2 className="text-4xl md:text-5xl text-center md:text-start text-white font-['familjen_grotesk']">CAD Chaos</h2>
                <h2 className='text-3xl md:text-4xl text-center md:text-start text-white'>(CAD)</h2>
            </div>
            <div>
        ...
        {/* Right side img */}
        <div className='bg-[#838383] bg-opacity-10 p-4 md:p-0 aspect-video w-2/3 max-w-[500px] rounded-xl flex justify-center items-center'>
