...
function TinkerTracksPopover() {
  return (
    <Popover className="relative flex flex-col justify-center items-end gap-2 w-full">
      <Popover.Button className="text-[#959499] underline w-full text-end focus:outline-none">Recommended Tracks for event participating teams.</Popover.Button>
      ...
      <Popover.Panel className="z-10">
        ...
        >
            <ul className='list-disc font-semibold grid grid-cols-2'>
