...
function Navbar() {
  ...
  return (
    <>
    {visible && (
      <nav className="fixed bottom-0 w-[95%] min-w-[300px] md:max-w-[500px] h-[8vh] min-h-[70px] max-h-[80px] bg-[#1d1d1d] bg-opacity-90 rounded-xl m-2 px-3 gap-2 flex justify-center items-center">
        {/* First link */}
